...
# Import handlers
from handlers import start, callbacks, admin, messages, user_commands, targeted_broadcasts, test_commands
...
dp.include_router(targeted_broadcasts.router)
dp.include_router(test_commands.router)
